...
# New Navbar HTML from index.html (adjusted for services directory)
NEW_NAVBAR = """        <nav class="navbar navbar-expand-lg fixed-top" id="mainNavbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../index.html#section_4">Gallery</a></li>
                        <li class="nav-item"><a class="nav-link" href="../index.html#section_5">Contact Us</a></li>
                    </ul>
...
SERVICES_DIR = r"c:\Users\hp\OneDrive\Desktop\j-h-main\j-h-main\services"

def update_navbar(file_path):
    with open(file_path, 'r', encoding='utf-8') as f:
        content = f.read()
    
    # Use a more flexible search for the <nav> block
    start_search = '<nav'
    end_search = '</nav>'
